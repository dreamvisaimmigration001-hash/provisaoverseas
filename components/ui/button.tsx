...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-bg-primary hover:bg-primary/90 shadow-sm",
        gold: "bg-accent text-white hover:bg-accent/90 shadow-sm",
        outline: "border border-border text-primary hover:bg-bg-secondary",
        ghost: "hover:bg-bg-secondary hover:text-primary",
